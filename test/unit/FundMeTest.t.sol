...
contract FundMeTest is Test {
    ...
    function testOwnerIsMsSender() view public{
    ...
    function testFundUpdatesFundedDataStructers() public{
        vm.prank(USER);
    ...
    function testAddsFundersArrayOfFubders() public {
        vm.prank(USER);
        fundMe.fund{value: SEND_VALUE}();
    ...
    function testWithdrawWithASingleFunder() public funded {
        ...
        assertEq(startingOwnerBalance + startingFundMeBalance, finalOwnerBalance);
    }
